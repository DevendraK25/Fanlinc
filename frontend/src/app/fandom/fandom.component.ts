...
export class FandomComponent implements OnInit {
	...
	constructor(private router: Router, private postService: PostService, private fandomService: FandomService) {
	}
      ...
      this.fandomService.getAllFandoms().subscribe(
        res => {
          if (res.status == 200) {
			...
			//this.fandomNames = nameToImageFandom.keys();
			//this.fandomImages = nameToImageFandom.values();
          }
        },
        err => {
